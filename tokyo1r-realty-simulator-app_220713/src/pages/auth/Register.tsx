        ...
        {mdUp && (
          <SectionStyle>
            <Typography variant="h3" sx={{ px: 5, mt: 10, mb: 5 }}>
              {translate('auth.register.header')}
            </Typography>
            <Image
              alt="register"
          ...
          <ContentStyle>
            <Box sx={{ mb: 5, display: 'flex', alignItems: 'center' }}>
              <Box sx={{ flexGrow: 1 }}>
                <Typography variant="h4" gutterBottom>
                  {translate('auth.register.getStartedAbsolutelyFree')}
                </Typography>
              </Box>
            ...
            <Typography variant="body2" align="center" sx={{ color: 'text.secondary', mt: 3 }}>
              <Link underline="always" color="text.primary" href="#">
                {translate('auth.register.termsOfUse')}
              </Link>
              {''}
              {translate('auth.register.and')}
              {''}
              <Link underline="always" color="text.primary" href="#">
                {translate('auth.register.privacyPolicy')}
              </Link>
              {translate('auth.register.iAgreeTo')}
            </Typography>
